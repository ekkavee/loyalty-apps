...
.controller('FoodCtrl', function($scope, $rootScope, Listings, $q, $ionicHistory, Members, $state, $ionicLoading, $window, PROFILE_DEFAULT, $ionicSlideBoxDelegate, SocialMediaReader, $timeout, $ionicModal, OrderModal, enquiryPopup){
  // $scope.listings = [];
  // $scope.currentTab = 1;

  $scope.init = function(){
    var listing_id = '19';
    // if($rootScope.member.member.member_tier.tier.id == 1){
    //   listing_id = '15';
    // }
