...
.controller('RedeemCtrl', function($scope, $rootScope, Listings, $q, Members, $state, $ionicLoading, $window, PROFILE_DEFAULT, $ionicSlideBoxDelegate, SocialMediaReader, $timeout, $ionicModal, OrderModal, enquiryPopup){
  $scope.listings = [];
  // $scope.currentTab = 1;

  $scope.init = function(){
    Listings.getListings('12').then(function(s){
