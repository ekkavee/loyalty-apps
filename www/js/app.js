...
angular.module('starter', ['ionic', 'starter.controllers', 'app.services', 'app.directives', 'app.filters', 'ngCordovaOauth', 'ngTwitter', 'angularMoment', 'slickCarousel', 'barcode', 'ngFileUpload', 'ion-google-autocomplete', 'credit-cards', 'ionicLazyLoad', 'ngInputCurrency', 'ion-datetime-picker', 'angularLazyImg', 'ionic-ratings'])
  ...
  //.constant('API_URI', 'https://api.vecport.net/bended-elbow/public/api/')
